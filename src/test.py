...
def _create_validation_data_loader(valid_data_path, batch_size, img_size, n_cpu):
    """
...
def run():
    ...
    parser.add_argument(
        "-m", "--model", type=str, default="config/yolov3.cfg", help="Path to model definition file (.cfg)"
    )
    parser.add_argument(
        "-w",
        "--weights",
