...
def main(
    ...
    train_dataset = KITTI2D(data_path, mode="Train")
    valid_dataset = KITTI2D(data_path, mode="Validate")
    ...
    valid_dataloader = DataLoader(
        valid_dataset, batch_size=batch_size, shuffle=False, collate_fn=valid_dataset.collate_fn
    )
